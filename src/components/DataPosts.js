                    ...
                    <span className="text-[8px] grid grid-cols-1 text-gray-900">
                      <>
                        ...
                        <button
                          ...
                          className="text-sm hover:text-violet-500 transition duration-100 w-fit font-bold text-gray-400 hover:underline decoration-2 hover:decoration-violet-600 "
                        >
                          Show Post
                        </button>
                      </>
